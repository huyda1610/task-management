  ...
  return (
    <div className="relative">
      <button onClick={toggleDropdown} className="flex items-center text-gray-700 dark:text-gray-400">
        ...
        <span className="text-theme-sm mr-1 block font-medium">Huy</span>
      ...
      >
        <div>
          <span className="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">Do Anh Huy</span>
          <span className="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">huyda1610@gmail.com</span>
        </div>
